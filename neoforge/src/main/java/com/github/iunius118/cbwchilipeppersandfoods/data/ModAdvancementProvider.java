...
public class ModAdvancementProvider extends AdvancementProvider {
    ...
    private static class ModAdvancementGenerator implements AdvancementSubProvider {
        ...
        public void generate(HolderLookup.Provider provider, Consumer<AdvancementHolder> consumer) {
            ...
            AdvancementHolder root = Advancement.Builder.recipeAdvancement()
                    ...
                    .addCriterion("has_curved_chili",
                            InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.CURVED_CHILI))
            ...
            AdvancementHolder harvestedChiliPepperWithShears = Advancement.Builder.recipeAdvancement()
                    ...
                    .save(consumer, "%s:%s/%s".formatted(Constants.CBW_MOD_ID, "main",
                            harvestedChiliPepperWithShearsName));
            ...
            AdvancementHolder halfSandwich = addItemAdvancement(curvedChili, ModItems.HALF_CHILI_POTATO_SANDWICH,
                    AdvancementType.TASK, "half_sandwich", halfSandwiches, "main", consumer);
            ...
            AdvancementHolder threwHotSauce = Advancement.Builder.recipeAdvancement()
                    ...
                    .addCriterion("threw_hot_sauce",
                            ThrewHotSauceTrigger.TriggerInstance.threwHotSauce(items, ModItems.HOT_SAUCE))
                    .addCriterion("threw_green_hot_sauce",
                            ThrewHotSauceTrigger.TriggerInstance.threwHotSauce(items, ModItems.GREEN_HOT_SAUCE))
                    .requirements(AdvancementRequirements.Strategy.OR)
                    .save(consumer, "%s:%s/%s".formatted(Constants.CBW_MOD_ID, "main", threwHotSauceName));

            // 1-4. Corrosive, Toxic, Irritant
            AdvancementHolder capsicumCrystal =
                    addItemAdvancement(curvedChili, ModItems.CAPSICUM_CRYSTAL, AdvancementType.TASK,
                            new Item[]{ModItems.CAPSICUM_CRYSTAL}, "main", consumer);

            // 1-4-1. Fer-Ro-Cap-Sic ... What?
            AdvancementHolder ferrocapsicumiumIngot =
                    addItemAdvancement(capsicumCrystal, ModItems.FERROCAPSICUMIUM_INGOT, AdvancementType.TASK,
        ...
        private AdvancementHolder addItemAdvancement(AdvancementHolder parent, Item icon,
                                                     AdvancementType advancementType, String name, Item[] requirements,
                                                     String tab, Consumer<AdvancementHolder> consumer) {
        ...
        private AdvancementHolder addItemAdvancement(AdvancementHolder parent, Item icon,
                                                     ...
                                                     String tab, Consumer<AdvancementHolder> consumer) {
            return addItemAdvancement(parent, icon, advancementType,
                    getItemId(requirements[0]).getPath(), requirements, tab, consumer);
        }
